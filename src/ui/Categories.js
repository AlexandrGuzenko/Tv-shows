...
Popular
        ...
        <a className={styles.category} onClick={() => onClick('https://api.trakt.tv/shows/trending?extended=full', 'Trending', true)}>
Trending
        </a>
        <a className={styles.category} onClick={() => onClick('https://api.trakt.tv/shows/anticipated?extended=full', 'Most unticipated', true)}>
Most unticipated
        </a>
